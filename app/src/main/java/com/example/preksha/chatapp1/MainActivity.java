...
public class MainActivity extends AppCompatActivity {
    ...
    static final String APP_ID = "66543";
    static final String AUTH_KEY = "m46J2nkJXXsfdNB";
    static final String AUTH_SECRET = "RAAtHH8R7GD7SNv";
    static final String ACCOUNT_KEY = "m5dP2XNhyTmGPKPTjxzy";
            ...
            public void onClick(View v) {
                ...
                QBUsers.signIn(qbUser).performAsync(new QBEntityCallback<QBUser>() {
                    ...
                    public void onSuccess(QBUser qbUser, Bundle bundle) {
                        ...
                        finish();//clear login activity after logged in
