package com.example.preksha.chatapp1.Adapter;
...
import com.example.preksha.chatapp1.R;
        ...
        if (view==null)
        {
         ...
         view=inflater.inflate(R.layout.list_chat_dialog,null);
            ...
            TextDrawable.IBuilder builder=TextDrawable.builder().beginConfig().withBorder(4)
                    .endConfig()
                    .round();
            //get first character from Chat Dialog Title for create cat Dialog image
